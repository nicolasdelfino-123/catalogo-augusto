...
import maskking from '@/assets/maskking.webp'
import nikbar from '@/assets/nik1.jpg'
import vaporesso from '@/assets/vaporesso.jpg'
...
*/}
            ...
            <section className="bg-gray-900 text-white min-h-[65vh] flex flex-col justify-end relative overflow-hidden">
                ...
                <div className="absolute inset-0 z-0">
                    <img
                        ...
                        className="w-full h-[70vh] md:w-[100%] md:h-[85vh] object-cover opacity-30 mx-auto"
                        loading="eager"
                        decoding="async"
                    />
                </div>
                        ...
                        <Link
                            ...
                            onClick={() => {
                                ...
                                setTimeout(() => {
                                    ...
                                    // Desplaza hasta el tope real de la página (restando el header)
                                    window.scrollTo({
                                        top: 0 - headerH - 8,
                                        behavior: "smooth"
                                    });
  ...
  `}</style>
            ...
            {/* === CARRUSEL DE MARCAS (scroll infinito perfectamente espaciado) === */}
                    ...
                    <div className="brands-track will-change-transform">
                        ...
                        <div className="brands-group">
                            <div className="brand-container">
                                <img src={maskking} alt="Maskking" className="brand-img" />
                            </div>
                            <div className="brand-container">
                                <img src={zomo} alt="Zomo" className="brand-img" />
                            </div>
                            <div className="brand-container">
                                <img src={elfbar} alt="Elfbar" className="brand-img" />
                            </div>
                            <div className="brand-container">
                                <img src={nikbar} alt="Nikbar" className="brand-img" />
                            </div>
                            <div className="brand-container">
                                <img src={vaporesso} alt="Vaporesso" className="brand-img" />
                            </div>
                            <div className="brand-container">
                                <img src={ignite} alt="Ignite" className="brand-img" />
                            </div>
                            <div className="brand-container">
                                <img src={lostmary} alt="Lost Mary" className="brand-img" />
                            </div>
                        </div>
